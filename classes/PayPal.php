...
class PayPal {
    ...
    private $_notify_url;
    //currency code
    private $_currency_code = 'EURO';
    // tax or vat amount for _cart
    public $_tax_cart = 0;
    ...
    private function standardFields() {
        ...
        $this->addField('currency_cod', $this->_currency_code);
        $this->addField('rm', 2);
        ...
        if ($this->validateIpn()) {
            ...
            if (strcmp($this->_ipn_result, "VERIFIED") == 0) {
                ...
                /*
                  ...
                  $this->_ipn_data['paymment_status'],
                ...
                if (!empty($this->_ipn_data)) {
                    $objOrder->approve(
                            $this->_ipn_data, $this->_ipn_result
                    );
                }
            }
            ...
            //$this->saveLog();
            /*
             * este metodo fue para añadir los datos del pago en PayPal.com
             * despues de realizarlo a un archivo de tipo log
             * se llama "ipn.log" ... pero lo hemos cancelado porque es mejor
             * añadir esos datos en la base de datos en la tabla "orders" columna "ipn"
             * 
             */
        }
    }
    ...
    public function validateIpn() {
        ...
        //check if post has been recived from paypal.com
        ...
        if (
                ...
                array_key_exists('reciver_email', $this->_ipn_data) &&
    ...
    //Este metodo ya no se usa mas
    //la dejo, solamente, para aprender como se guardan los datos en un fichero
